                            ...
                            <div class="row m-2">
                                <ul style="list-style: none;" >
                                    ...
                                    <li style="font-style:itali;"> 
                                        ...
                                        ?></li>
                                    <li>-->
                                        <button class="btn btn-outline-secondary alterar_usuario m-2" value="<?php echo $linha["id_usuario"]?>" data-toggle="modal"
                                                data-target="#modal_alterar_usuario">Alterar Dados</button>
                                        <button class="btn btn-outline-danger alterar_usuario m-2" value="<?php echo $linha["id_usuario"]?>" data-toggle="modal"
                                        data-target="#modal_excluir_usuario">Excluir Conta   </button>
                                    </li>
                                </ul>
                            </div>
					    </div>
