    ...
    <div class="modal-dialog">
         <div class="modal-content">
             <div class="card-body">
                ...
                <button class="btn btn-lg btn-google btn-block text-uppercase btn-secondary" style="background-color:#828282;" type="submit" onclick = "location.href='atividade_<?php echo $_SESSION['condicao_auditiva'];?>.php?pagina=7'">Atividades Numeros</button>
                <button class="btn btn-lg btn-google btn-block text-uppercase btn-secondary" style="background-color:#828282;" type="submit" onclick = "location.href='atividade_<?php echo $_SESSION['condicao_auditiva'];?>.php?pagina=8'">Atividades Letras</button>
