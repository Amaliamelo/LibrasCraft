                ...
                <div class="card-body">
                    <div class="card">
                        ...
                        <div class="modal-footer">
                            ...
                            <button class="btn btn-lg btn-success text-uppercase " id="btn-modal-finalizar" style="display:none;" data-toggle="modal" data-target="#modal-mensagem">FINALIZAR</button> <!-- BOTAO MODAL FINALIZAR -->
